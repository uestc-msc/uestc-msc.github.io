...
![img](666-1.将Bot发布至Azure云/afs5d-12.png)
...
![img](666-1.将Bot发布至Azure云/afs5d-13.png)

既然就有这个能用，你就新建一个用用看：

![img](666-1.将Bot发布至Azure云/afs5d-14.png)
...
![img](666-1.将Bot发布至Azure云/afs5d-15.png)

或者这样：

![img](666-1.将Bot发布至Azure云/afs5d-17.png)

进入发布页面，发布目标当然是Azure云，然后下面的新建/选择现有的选项也不用动，因为我们是第一次发布。

![img](666-1.将Bot发布至Azure云/afs5d-18.png)
...
![img](666-1.将Bot发布至Azure云/afs5d-19.png)
